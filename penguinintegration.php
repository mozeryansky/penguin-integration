...
Description: Penguin Integration allows you to easily add Penguin buttons to your site so you can start accepting Apple Pay today. To begin, login on the <a href="./options-general.php?page=penguin-integration" target="_self" >settings page</a> to being.
Version: 1.0
Author: Penguin
...
class PenguinIntegration
{
    ...
    function createIFrame($atts)
    {
        ...
        ob_start();
?>
        <iframe src="http://getpenguin.com/iframe?productId=<?=$productId?>" width="190px" height="100px"></iframe>
<?php
